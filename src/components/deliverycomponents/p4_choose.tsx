...
export default function choose() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#28a4a4] to-[#208585] w-full my-[8vh] py-[5vh] px-[15vh] flex justify-between items-center">
      ...
      <div className="w-1/2 flex flex-wrap gap-6 justify-between">
        {chooseItems.map((item, index) => (
          <div key={index}  className="flex flex-col w-[47%] bg-white p-8 text-black gap-4 rounded-2xl ">
            <Image
              alt="1"
